...
import { analyze, formatSummary } from "./analyzer.js";
const { Client } = pg;
function printHelp() {
    console.log(`
...
async function runExplain(query, connectionString, doAnalyze) {
...
async function main() {
    ...
    const filteredArgs = args.filter((a) => !["--json", "--no-analyze", "--file"].includes(a));
