...
const { Client } = pg;
async function runExplain(connectionString, query, doAnalyze) {
...
server.tool("explain_query", "Run EXPLAIN ANALYZE on a PostgreSQL query and return a structured analysis: plan tree, summary (execution time, slowest node, seq scans, buffer stats), and recommendations.", {
...
server.tool("explain_file", "Run EXPLAIN ANALYZE on a SQL query read from a file.", {
